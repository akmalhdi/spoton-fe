        ...
        <div className="w-full">
          ...
          <div className="space-y-3">
            {transaction.purchasedItems.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-2 flex gap-2 items-center">
                ...
                <div className="font-medium text-sm ml-auto">{item.qty} units</div>
              </div>
            ))}
          </div>
          <div className="flex justify-between mt-5 font-semibold text-sm">
            <h4>Total</h4>
