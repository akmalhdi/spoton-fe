          ...
          <div className="flex justify-between p-5">
            <div className="flex gap-2 items-center">
              ...
              <div>
                ...
                <div className="text-xs opacity-50">bank transfers</div>
              </div>
            </div>
            <div className="flex gap-2 -mt-5 text-gray-600">
              <button>
                <FiEdit2 className="cursor-pointer" size={20} onClick={() => onEdit(data)} />
              </button>
              <button>
                <FiTrash2 className="cursor-pointer" size={20} onClick={() => onDelete(data._id)} />
              </button>
            </div>
          </div>
