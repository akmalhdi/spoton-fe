    ...
    <CardWithHeader title="Cart Items">
      <div className="flex flex-col justify-between h-[calc(100%-70px)]">
          ...
          {items.map((item) => (
            <div className="border-b border-gray-200 p-4 flex gap-3" key={item._id}>
              <div className="bg-primary-light aspect-square w-16 flex justify-center items-center">
                <Image className="aspect-square object-contain" src={getImageUrl(item.imageUrl)} width={63} height={63} alt={item.name} />
              </div>
        ...
        <div className="border-t border-gray-200 p-4">
          ...
          <Button variant="dark" className="w-full mt-5" onClick={handlePayment}>
