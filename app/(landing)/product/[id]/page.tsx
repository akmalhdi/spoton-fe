  ...
  return (
    <main className="container mx-auto py-40 flex gap-12">
      ...
      <div className="w-full py-7">
        ...
        <div className="bg-primary-light rounded-full text-primary w-fit py-2 px-6 mb-5">Football</div>
        ...
        <div className="text-primary text-[32px] font-semibold mt-7 mb-11">{priceFormatter(458000)}</div>
        <ProductActions />
      </div>
    </main>
  );
