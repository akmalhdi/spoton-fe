  ...
  return (
    <main className="container mx-auto py-40 flex gap-12">
      ...
      <div className="w-full py-7">
        ...
        <div className="bg-primary-light rounded-full text-primary w-fit py-2 px-6 mb-5">{product.category.name}</div>
        <p className="leading-loose">
          {product.description}
        </p>
        <div className="text-primary text-[32px] font-semibold mt-7 mb-7">{priceFormatter(product.price)}</div>
